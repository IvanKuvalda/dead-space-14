...
app-catalog-entry-snake-desc = Классическая игра «Змейка» для КПК.
app-catalog-entry-scanner-name = Сканер документов
app-catalog-entry-scanner-desc = Программа для сканирования документов.
